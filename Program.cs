...
app.MapPost("/administradores", ([FromBody] AdministradorDTO administradorDTO, IAdministradorServico administradorServico) =>
{
    ...
    return Results.Created($"/admnistradores/{administrador.Id}", new AdministradorModeView
    {
        Id = administrador.Id,
...
}).RequireAuthorization(new AuthorizeAttribute { Roles = "Adm, Editor" }).RequireAuthorization().WithTags("Veiculo");
...
}).RequireAuthorization(new AuthorizeAttribute { Roles = "Adm" }).RequireAuthorization().WithTags("Veiculo");
